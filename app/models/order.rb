class Order < ActiveRecord::Base
    ...
    validates :phone, :origin_home_phone, :origin_work_phone, :origin_cell_phone, :destination_home_phone, :destination_work_phone, :destination_cell_phone, format: { with: /\d{3}-\d{3}-\d{4}/, message: "not a valid phone number. Format as 555-555-1212" }
end
